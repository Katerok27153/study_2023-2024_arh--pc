...
8. Написать программу, которая для введённых значений x и a вычисляет значение заданной функции f(x). Вид функции и значения брать из определённой таблицы, в соответствии с полученным вариантом (В наше случае это 17 вариант). 

# Выполнение лабораторной работы

## Реализация переходв в NASM
